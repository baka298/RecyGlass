      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-6 portfolio-item">
              ...
              <img class="img-fluid w-100" src="{{Storage::disk('public')->url($partner->image)}}" alt="">
            </a>
            <div class="portfolio-caption">
							<h4>{{$partner->company}}</h4>
							@if ($partner->site)
						<p class="text-muted"><a target="_blanck" href="http://{{$partner->site}}">WebSite</a></p>
							@endif
        ...
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading text-uppercase">Contactez Nous</h2>
						<h3 class="section-subheading text-muted" style="color:white !important;">Voulez-vous devenir partenaire ? Cliquez <a href="/custom-register"><strong>ici</strong></a></h3>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-12">
